...
<body>
	...
	$sql = "SELECT * FROM restaurant_owner WHERE owner_id = '$owner';";
...
<div id="main">
    ...
    <div class="all-item">
		...
		<form action="admin-menu-update-process.php?action=edit" method="POST" enctype="multipart/form-data " onsubmit=" return success()">
		<div class="addForm">

			<?php
			
            $food_menu = "SELECT * FROM food WHERE owner_id ='".$owner."' AND food_id = '".$food."';";
        ...
        ?>
				<div class="leftcol " >
					<div class=input-col1>
						...
						<input type="text" id="prodID" name="foodName" value="<?php echo $food_name;?>"  ><br>
						
					</div>
					<div class=input-col1>
						<label for="prodId">Food Category</label>
						<select id="prodId" name="foodType" value="<?php echo $food_type_id;?>" >
					...
					<div class="col1">
						...
						<input type="text" name="foodPrice" value="RM<?php echo $food_price;?>"  ><br>
                    </div>
                    <input  type="hidden" name="foodID" value="<?php echo $food;?>" required ><br>
                    <input  type="hidden" name="ownerID" value="<?php echo $owner;?>" required><br>
				</div>
				<?php
		...
		<div class="addorderBTN">
			<center><button type="submit" value="Add product" name="submit">UPDATE FOOD</button></center>
		</div>
	</form>
